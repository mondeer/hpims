...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/system/admin" class="logo">
      ...
      <span class="logo-lg"><b>HP</b>IMS</span>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-graduation-cap"></i> <span>Manage Patients</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="/patient/enroll"><i class="fa fa-circle-o"></i> Admit Patient</a></li>
            <li><a href="/patient/view"><i class="fa fa-circle-o"></i> View Patients</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-sitemap"></i> <span>Manage Wards</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-circle-o"></i>View Wards</a></li>
            <li><a href="#"><i class="fa fa-circle-o"></i> Classes</a></li>
          </ul>
        </li>

        <li class="treeview">
          <a href="#">
            <i class="fa fa-bar-chart"></i> <span>Beds</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="#"><i class="fa fa-pencil"></i> Add Bed</a></li>
            <li><a href="#"><i class="fa fa-eye"></i> View Beds </a></li>
            <li><a href="#"><i class="fa fa-eye"></i> Allocate Bed </a></li>
          </ul>
        </li>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2017 <a href="imond.co.ke">Grace Bisem</a>.</strong> All rights
    reserved.
  </footer>
